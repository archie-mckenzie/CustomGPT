...
Another model you might want to try is "gpt-4". GPT-4 is a OpenAI's latest and greatest language model. It's more capable, but also slower and more expensive than "gpt-3.5-turbo".
